...
def main():
    ...
    while run:
        ...
        if hit:
            ...
            time_lasted = FONT.render(
                f"You lasted {elapsed_time}s", 1, "white", )
            WIN.blit(time_lasted, (WIDTH/2-time_lasted.get_width() /
                     2, HEIGHT/2-time_lasted.get_height()/2+time_lasted.get_height()))
            pygame.display.update()
